...
from corruption_by_age.database import Diagnosis, Images, get_diagnosis_list, session_scope, Base, engine
from corruption_by_age.visualization import plot_labels, plot_rebalanced_dataset
from corruption_by_age.dataset import create_corrupted_labels
...
def cook_dataset() -> None:
    ...
    undersample_dataset()
    logger.info("Creating corrupted labels")
    create_corrupted_labels()
