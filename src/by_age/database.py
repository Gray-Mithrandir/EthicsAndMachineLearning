...
engine = create_engine("sqlite:///data/database_by_age.sqlite")
...
class RunStatus(Base):
    ...
    """Network name"""
    reduce_by_above: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    """Test metric: Above/Below average or Both"""
